<template>
  <section
    id="funcionalidades"
    class="relative scroll-mt-24 overflow-hidden border-y border-white/10 px-6 py-12 md:py-20"
  >
      ...
      <div class="w-full space-y-8 md:space-y-10">
        ...
        >
          ...
          >
            ...
            <!-- min-h tuned per breakpoint so the tallest card (calendar / whatsapp) never gets clipped by contain:paint -->
            <div
              class="order-1 relative flex min-h-[34rem] items-center justify-center sm:min-h-[36rem] md:min-h-[38rem] lg:order-2 lg:min-h-[35rem]"
            >
              ...
              >
                <Transition name="card-fade" mode="out-in">
                  ...
                  >
                          ...
                          <div>
                            ...
                            <div class="grid grid-cols-7 gap-1 font-mono text-[9px] text-white/20">
                              <div
                                v-for="day in 21"
                                :key="`pre-${day}`"
                                class="flex aspect-square items-center justify-center border border-white/5"
                              >
                                {{ String(day).padStart(2, '0') }}
                              </div>
                              <div
                                class="flex aspect-square items-center justify-center border border-acid-green/40 bg-acid-green/5 font-bold text-acid-green"
                              >
                                22
                              </div>
                              <div
                    ...
                    <div
                      v-else
                      class="relative aspect-[9/18.5] h-full w-auto max-w-full rounded-[3rem] border-[12px] border-white/5 p-4 shadow-[0_60px_150px_rgba(192,255,0,0.15)] glass"
                    >
                      <div
                        class="-mx-4 -mt-4 mb-4 flex items-center gap-3 rounded-t-[2.2rem] bg-[#075e54] p-5"
                      >
                        <div
                          class="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/20 text-xs"
                        >
                          G
                        </div>
                        <div>
                      ...
                      <div class="space-y-4 px-2">
                        ...
                        <div
                          class="w-[90%] rounded-2xl rounded-tl-none bg-[#dcf8c6] p-4 text-[11px] text-black shadow-lg msg-bubble-2"
                        >
                      ...
                      <div
                        class="absolute bottom-6 left-6 right-6 flex h-12 items-center rounded-full border border-white/10 bg-white/5 px-5"
                      >
