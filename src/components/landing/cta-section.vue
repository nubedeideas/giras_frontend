...
<template>
  <section
    id="cta"
    class="py-16 px-6 relative overflow-hidden scroll-mt-24"
  >
    <div class="max-w-4xl mx-auto text-center relative z-10 reveal-up">
      ...
      >
        ...
        <p
          v-if="emailError"
          class="mt-4 text-[10px] font-bold uppercase tracking-[0.18em] text-red-400"
        >
          {{ emailError }}
        </p>
      </form>
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 w-[800px] h-[800px] bg-acid-green/5 blur-[150px] rounded-full" />
  </section>
</template>
