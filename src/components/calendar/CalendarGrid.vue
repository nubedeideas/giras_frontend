...
<template>
  ...
  >
    <!-- No tour selected — same picker as Tour/Events/Contacts, replacing the
    whole card (header included, since its own tour <select> below would
    otherwise duplicate this) -->
    <TourSelectPrompt v-if="!tours.activeTourId" />
