  ...
  <div class="flex-1 bg-bg-3 flex flex-col overflow-hidden">
    ...
    <div class="px-[22px] pt-[18px] pb-3.5 border-b border-line flex-shrink-0 flex items-start justify-between">
      <div>
        ...
        <p class="text-lg font-bold tracking-[-0.3px] mb-1 text-ink">
          {{ event.title }}
        </p>
    ...
    <div class="flex-1 overflow-y-auto px-[22px] py-[18px]">
      ...
      <GlassBlock :title="t('notif.notifMsg')">
        <p class="text-[12px] leading-7 text-ink whitespace-pre-line">
          {{ event.message }}
        </p>
      </GlassBlock>
      ...
      <GlassBlock :title="t('notif.stats')">
        <div class="grid grid-cols-3 gap-2">
          ...
          >
            <p
              class="text-[22px] font-bold tracking-[-0.5px]"
              :class="s.cls"
            >
              {{ s.val }}
            </p>
            <p class="text-[10px] text-ink-3 mt-px">
              {{ s.lbl }}
            </p>
          </div>
        </div>
      ...
      <GlassBlock>
        <div class="flex items-center justify-between mb-2.5">
          ...
          <Pill variant="n">
            {{ event.contacts.length }} {{ t('notif.contacts') }}
          </Pill>
        </div>
        <div class="flex flex-col gap-1.5">
          ...
          >
            <div
              class="w-[30px] h-[30px] rounded-full overflow-hidden flex-shrink-0 border border-line flex items-center justify-center text-[11px] font-bold text-ink-2"
