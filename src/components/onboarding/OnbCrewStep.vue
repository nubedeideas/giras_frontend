  ...
  <div>
    ...
    <template v-if="source === 'google'">
      ...
      <template v-else>
        ...
        <!-- LOADING / SYNCING -->
        <div
          v-else-if="gStep === 'loading' || gStep === 'syncing'"
        ...
        <div v-else-if="gStep === 'selecting'">
          ...
          <div class="max-h-48 overflow-y-auto mb-4 border border-line rounded-lg overflow-hidden">
            ...
            >
              ...
              <div
                class="w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center text-[10px] font-bold text-ink-2 border border-line"
                :style="{ background: c.role?.color ?? 'var(--bg4)' }"
              >
    ...
    <template v-else>
      ...
      >
        ...
        <p class="text-[11px] text-ink-3 mb-5">
          {{ createdContact?.full_name }} fue añadido al crew
        </p>
        <div class="flex gap-2">
          <BtnPrimary
            full
        ...
        <div class="grid grid-cols-2 gap-2">
          <div>
            ...
            <div class="relative flex items-center">
              <div
                v-if="form.role"
                class="absolute left-2.5 w-2 h-2 rounded-full pointer-events-none"
