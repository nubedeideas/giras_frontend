  ...
  <div class="flex-1 bg-bg-3 flex flex-col overflow-hidden">
    ...
    <div class="px-6 pt-6 pb-5 border-b border-line flex-shrink-0">
      <div class="flex items-start gap-4 mb-4">
        <!-- Avatar -->
        <div
          class="relative w-14 h-14 rounded-full overflow-hidden flex-shrink-0 border-2"
        ...
        <div class="flex-1">
          ...
          <p
            ...
            class="text-[12px] text-ink-2 mb-0.5"
          >
            {{ contact.job_title }}
          </p>
          <p
            v-if="contact.company_name"
            class="text-[11px] text-ink-3 mb-1.5"
          >
      ...
      <div class="flex gap-2">
        ...
        <BtnSecondary
          small
          @click="contactStore.removeContact(contact.uuid)"
        >
          <svg
            width="11"
            height="11"
    ...
    <div class="flex-1 overflow-y-auto px-6 py-5 space-y-4">
        ...
        <div class="flex flex-col gap-3">
          ...
          >
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="text-ink-3 flex-shrink-0 mt-px"
            >
            ...
            <div class="flex-1">
              <p class="text-[9px] text-ink-3 uppercase tracking-[0.5px] font-semibold mb-0.5">
                {{ t('contacts.phone') }}
              </p>
          ...
          <!-- Location -->
          <div
            v-if="contact.city || contact.country"
          ...
          >
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="text-ink-3 flex-shrink-0"
            >
              <circle
                cx="12"
                cy="10"
          ...
          >
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                class="text-[12px] text-acid-muted hover:text-acid transition-colors truncate block"
              >
                {{ contact.website }}
              </a>
            </div>
      ...
      <!-- Tour relations -->
      <GlassBlock
        v-if="contact.tour_relations?.length"
        :title="t('contacts.tours')"
      >
      ...
      <GlassBlock :title="t('contacts.notifications')">
        ...
        >
          ...
          >
            ...
            <div class="text-right flex-shrink-0">
              <p class="text-[10px] font-bold text-acid">
                {{ ev.stats.sent }}
              </p>
              <p class="text-[9px] text-ink-4">
                env.
              </p>
            </div>
          </div>
        ...
        <p
          v-else
          class="text-[12px] text-ink-3 text-center py-2"
        >
          {{ t('contacts.noNotifications') }}
        </p>
      </GlassBlock>
    </div>
  </div>
