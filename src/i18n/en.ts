export default {
  ...
  tourHub: {
    noActiveTour: 'Select a tour to see its documents, conflicts and insights',
    tabs: {
      insights: 'Insights',
      documents: 'Documents',
      conflicts: 'Conflicts',
    ...
    insights: {
      ...
      byStatus: 'By status',
      loadError: 'Error loading tour insights',
    },
    documents: {
      title: 'Documents',
      subtitle: 'Riders, visas, insurance and contracts for this tour',
      ...
      deleteYes: 'Delete',
      adminOnly: 'Only tour admins can upload or delete documents',
      loadError: 'Error loading documents',
      uploadedBy: 'Uploaded by',
    },
    conflicts: {
      title: 'Schedule conflicts',
      subtitle: 'Overlap or travel-time warnings between activities — never block the tour',
      empty: 'No pending conflicts',
      resolve: 'Resolve',
      resolving: 'Resolving…',
      resolvedBy: 'Resolved by',
      loadError: 'Error loading schedule conflicts',
    },
  },
  ...
  landing: {
    meta: {
      title: 'Giras — Automate Your Music Tour Logistics',
      description: 'Giras syncs your Google Calendar and automatically notifies your whole crew via WhatsApp. No manual lobby calls, no backstage chaos.',
    },
    header: {
      cta: 'Get Started',
  ...
  marketingLanding: {
    eyebrow: 'Giras',
    titleLine1: 'The Backstage,',
    titleHighlight: 'Organized.',
    intro: "Automate your tour's logistics communication with Giras.",
    placeholder: 'This page is customized for whichever marketing campaign links to it — final content is filled in before each launch.',
  },

  termsPage: {
    lastUpdated: 'September 2026',
    lastUpdatedLabel: 'Last updated:',
    metaDescription: "Terms and conditions of use for Giras, the logistics management platform for music tours.",
    eyebrow: 'Legal',
    titleLine1: 'Terms',
